...
from LiDAR_NET_CNN import LiDAR_NET_CNN,LiDAR_NET_CNN_seq
...
def train_model(train_set, model,Epoch,USE_GPU, log_interval, patience, lr):
        ...
        for phase in ['train', 'val']:
            ...
            for batch_idx, (inputs, targets) in enumerate(use_set):
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    ...
                    # yhat = yhat.argmax(-1).float()
                    # targets = targets.argmax(-1).float()
...
if __name__ == '__main__':  
    ...
    ckpt_dir='./LiDAR_NET_Pre_trained_model'
    ...
    train_model(train_set, model,Epoch=150, USE_GPU = USE_GPU,log_interval =50,patience=20,lr=0.001)    
